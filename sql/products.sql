...
CREATE TABLE products (id INT PRIMARY KEY AUTO_INCREMENT,
  ...
  shop_color VARCHAR(32),
  shop_system VARCHAR(32),
  shop_type VARCHAR(5),
  type_one VARCHAR(5),
...
("","亿航无人机4K高清航拍四轴飞行器vr眼镜智能","马卡龙配色 缤纷色彩 斑斓飞行","5999","50","马卡龙蓝^马卡龙粉^马卡龙黄^马卡龙紫","Android^iOS","1","","img/mall/products/b1.png^img/mall/products/b2.jpeg^img/mall/products/b3.jpeg^img/mall/products/b4.jpeg^img/mall/products/b5.jpeg"),
